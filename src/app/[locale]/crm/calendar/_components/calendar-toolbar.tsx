...
export function CalendarToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 border-b border-border bg-card/40 px-4 py-3">
      ...
      <Popover>
        <PopoverTrigger className="inline-flex items-center gap-1.5 rounded-md border border-border bg-background px-2.5 py-1.5 text-sm hover:bg-muted">
      ...
      {/* View switcher */}
      <div
        className="ml-1 flex items-center rounded-md border border-border bg-background p-0.5"
        role="tablist"
      >
        {VIEWS.map((v) => {
...
// ---------------------------------------------------------------------------
// MultiSelect — command-driven multi-select popover with search.
// ---------------------------------------------------------------------------
