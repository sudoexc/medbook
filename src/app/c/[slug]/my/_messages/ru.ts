export const ruDict = {
  ...
  book: {
    ...
    confirmPhoneFirst:
      "Перед записью подтвердите номер кнопкой выше: так регистратура сможет вам позвонить, а клиника найдёт вашу карту с историей визитов.",
  },
  phoneConfirm: {
    label: "Телефон",
    verified: "Подтверждён",
    notVerified: "Номер не подтверждён",
    hint: "Подтвердите номер одной кнопкой: Telegram передаст его клинике сам, без ошибок ввода.",
    button: "Подтвердить номер через Telegram",
    waiting: "Ждём подтверждение от Telegram…",
    done: "Номер подтверждён",
    failed: "Не получилось подтвердить. Посмотрите сообщение от бота в чате.",
    unsupported:
      "Обновите Telegram, чтобы подтвердить номер, или отправьте свой контакт боту в чате.",
  },
  done: {
