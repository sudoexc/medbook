  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        {/* maxBookableSlotsPerDay editor removed — two-lanes model
            (docs/TZ-two-lanes.md): the slot grid is the full schedule, the
            live queue is independent, so there is no per-day booking cap. */}
